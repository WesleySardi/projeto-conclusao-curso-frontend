const theme = {
  ...
  images: {
    ...
    headerCompanyLettersLogo: '../img/logos/tokyoLettersLogo.png',
    ...
    footerTokyoLogo: '../img/logos/logo_zlo_png.png',
    footerIcons: {
  ...
  mainTexts: {
    cardsUpperText: 'De pulseiras inteligentes a soluções personalizadas, oferecemos tecnologia que apoia pessoas com dependências a superar desafios diários. Com nossos produtos inovadores e expertise, garantimos que você tenha o suporte necessário para enfrentar e vencer as dificuldades do dia a dia.',
