  ...
  return (
    <>
      <MainContainer>
        ...
        <RightContainer>
          <CenteredText>
            Contamos com uma ampla linha de soluções para otimizar os resultados
            da sua empresa e tornar o dia a dia muito mais produtivo.
          </CenteredText>
        </RightContainer>
      </MainContainer>
      <ParentDiv>
        <ChildDiv
          backgroundImg="/img/backgroundCard11.png"
          backgroundColor="131, 2, 4, 1"
          animationDelay="0s"
        >
          <VisualContent>
            <StyledFontAwesomeIcon
              icon={faBoxesPacking}
              className={Icon.styledComponentId}
              size={"3x"}
            />
        ...
        <ChildDiv
          backgroundImg="/img/backgroundCard12.jpg"
        ...
        <ChildDiv
          backgroundImg="/img/backgroundCard10.png"
          backgroundColor="131, 2, 4, 1"
          animationDelay="2s"
        >
          <VisualContent>
